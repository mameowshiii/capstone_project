...
$captain = db_fetch_one(
  "SELECT name 
     FROM officials
     WHERE position LIKE '%Captain%'
     AND status='active'
     LIMIT 1"
);

$captain_name = $captain['name'] ?? 'HON. JERRY S. CARANZO';
...
$certificate_title = strtoupper($req['cert_name']);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <div class="official-group" style="margin-top:10px;">
            ...
            <div class="official-name">MARILYN C. ILUSTRISIMO</div>
          </div>
        </div>
      </div>
        ...
        <div class="doc-body">
          ...
          <p class="indent-para">
            This is to certify that <span class="underline-value"
              style="min-width: 150px;"><?= htmlspecialchars($full_name) ?></span>, <span class="underline-value"
              style="min-width: 30px; text-align: center;"><?= $age ?></span> years old is a resident of Purok
            <?= htmlspecialchars($req['purok']) ?> Barangay Pili, Madridejos, Cebu
            <?= $req['gender'] === 'Female' ? 'she' : 'he' ?> is personally known to me. was born on <span
              class="underline-value"
              style="min-width: 100px;"><?= date('F j, Y', strtotime($req['birthdate'])) ?></span>-.
          </p>

          <p class="indent-para">
            This certification is being issued upon the request of above named for
            <?= htmlspecialchars($req['purpose'] ?? '') ?> purpose this may serve his/her best.
          </p>

          <p class="indent-para">
            Issued this <u style="text-underline-offset: 2px;"><?= date('j') ?><sup><?= date('S') ?></sup></u> day of
            ...
            <table style="font-size: 13px; line-height: 1.4; border-collapse: collapse;">
              <tr>
                ...
                <td style="padding-left: 5px;"><span
                    style="display:inline-block; border-bottom: 1px solid #333; width: 80px; text-align:center;"><?= htmlspecialchars($req['receipt_number'] ?? '') ?></span>
                </td>
              </tr>
              <tr>
                <td>Certification fee</td>
                <td style="padding-left: 5px;">: <span style="text-decoration: underline;">P</span> <span
              ...
              <tr>
                ...
                <td style="padding-left: 5px;">: <span style="text-decoration: underline;">P</span> <span
                    style="display:inline-block; border-bottom: 1px solid #333; width: 60px; text-align:center;"></span>
                </td>
              </tr>
              <tr>
                <td>Amount paid</td>
